...
def generate_prompt(unranked_retrievals, user_query, listing_truncation_length_chars=50, generation_length_words=30):
    ...
    Synthesis Task 3: Provide a 1-sentence final conclusion summarizing if any listings particularly stand out, or if further information is needed to refine the search (not exceeding {generation_length_words} words).
